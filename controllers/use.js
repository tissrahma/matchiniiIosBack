...
export function putOnce(req, res) {
	User
	.findOneAndUpdate({ "login": req.params.login }, { "FirstName": req.body.FirstName,  "LasteName": req.body.LasteName,  "Age": req.body.Age ,  "Numero": req.body.Numero, "Sexe": req.body.Sexe ,"AboutYou" : req.body.AboutYou,"Job" : req.body.Job,"School" : req.body.School ,"Image" :`${req.protocol}://${req.get("host")}/img/${req.file.filename}` },{new: true})
	.then(doc => {
